<title>Edit Jenis Barang - Gecorp</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h4 class="m-b-10 ml-3">Jenis Barang</h4>
                                        </div>
                                        <ul class="breadcrumb ">
                                            <li class="breadcrumb-item ml-3"><a href="{{ route('master.index')}}"><i class="feather icon-home"></i></a></li>
                                            <li class="breadcrumb-item"><a href="{{ route('master.jenisbarang.index')}}">Jenis Barang</a></li>
                                            <li class="breadcrumb-item"><a>Edit Jenis Barang</a></li>
                                        </ul>
                                    </div>
