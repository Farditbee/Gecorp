                        ...
                        <div class="col-md-12">
                            <ul class="breadcrumb p-0 m-0" style="font-size: 18px">
                                ...
                                <li class="breadcrumb-item">
                                    <b class="font-weight-bold">Data Level Harga</b>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                            <div class="d-flex mb-2 mb-lg-0">
                                @if (Auth::user()->id_level == 1)
                                    <a href="{{ route('master.levelharga.create') }}" class="mr-2 btn btn-primary">
                                        <i class="fa fa-circle-plus"></i> Tambah
                                    </a>
                                @else
                                    <a href="{{ route('master.levelharga.create') }}" class="mr-2 btn btn-secondary disabled">
                                        <i class="fa fa-circle-plus"></i> Tambah
                                    </a>
                                @endif
                            </div>
                                    ...
                                    <table class="table table-hover m-0">
                                        <thead>
                                            <tr class="tb-head">
                                                ...
                                                <th class="text-wrap align-top">Nama Level Harga</th>
