                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Edit Data Pembelian Barang</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('master.index')}}"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{route('master.pembelianbarang.index')}}">Data Pembelian Barang</a></li>
                            <li class="breadcrumb-item"><a>Edit Data Pembelian Barang</a></li>
                        </ul>
                    </div>
                </div>
            </div>
